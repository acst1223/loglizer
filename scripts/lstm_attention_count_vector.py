...
flags.DEFINE_string('checkpoint_name', 'lstm_attention_plus_count_vector.h5', 'training directory')
...
if __name__ == '__main__':
    ...
    print('########### Start LSTM Attention with Count Vector on Dataset ' + dataset + ' ###########')
